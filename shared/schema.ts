...
export const properties = pgTable("properties", {
  ...
  arv: decimal("arv", { precision: 15, scale: 2 }),
  monthlyRent: decimal("monthly_rent", { precision: 10, scale: 2 }).default("0"),
  cashOnCashReturn: decimal("cash_on_cash_return", { precision: 8, scale: 2 }).default("0"),
  annualizedReturn: decimal("annualized_return", { precision: 8, scale: 2 }).default("0"),
  status: text("status", { enum: ["active", "sold", "under_contract"] }).default("active"),
